...
TEST(Vect_Alt_Signs_MPI, Test_Par_Count3) {
    ...
    if (rank == 0) {
        A = getRandomVector(n * n, left, right);
        b = getRandomVector(n, left, right);
        printVector(A, "A = ");
        printVector(b, "b = ");
    }
